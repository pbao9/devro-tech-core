...
class ActivateLicenseCommand extends Command
{
    ...
    {
        // BYPASS: Always use fake data
        $username = $this->option('buyer') ?: 'testuser';
        $purchasedCode = $this->option('purchase_code') ?: '12345678-1234-1234-1234-123456789012';
    ...
    protected function performUpdate(string $purchasedCode, string $username): int
    {
        ...
        $this->components->info('This license has been activated successfully (BYPASSED).');
