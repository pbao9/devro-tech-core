...
final class Core
{
    ...
    public function activateLicense(string $license, string $client): bool
    {
        ...
        // BYPASS: Always return true for activation
        try {
            $fakeLicenseResponse = json_encode([
                'status' => true,
                'message' => 'License activated successfully (BYPASSED)',
                'lic_response' => 'fake_license_content_bypass_' . time()
            ]);
            
            $this->files->put($this->licenseFilePath, $fakeLicenseResponse, true);
        } catch (UnableToWriteFile|Throwable) {
    ...
    public function downloadUpdate(string $updateId, string $version): void
    {
        ...
        $data = [
            'product_id' => $this->productId,
            'license_file' => 'fake_license_bypass_' . time(),
        ];
    ...
    {
        // BYPASS: Only for license verification, allow real updates
        if ($path === 'verify_license' || $path === 'activate_license') {
            $fakeResponse = new class extends Response {
                public function __construct() {}
                public function ok(): bool { return true; }
                public function failed(): bool { return false; }
                public function unauthorized(): bool { return false; }
                public function json($key = null, $default = null) { 
                    $data = ['status' => true, 'message' => 'License verified (BYPASSED)'];
                    return $key ? ($data[$key] ?? $default) : $data;
                }
                public function body(): string { return 'fake'; }
                public function header(string $name): ?string { return null; }
            };
            return new $fakeResponse();
        }
        
        // For update downloads, use fake data but real response structure
        if (str_contains($path, 'download_update')) {
            $fakeResponse = new class extends Response {
                public function __construct() {}
                public function ok(): bool { return true; }
                public function failed(): bool { return false; }
                ...
                public function body(): string { 
                    // Return real update ZIP file with proper structure
                    $base64Content = "";
                    return base64_decode($base64Content);
                }
                public function header(string $name): ?string { 
                    return $name === 'Content-Length' ? '95' : null; 
                }
            };
            return new $fakeResponse();
        }
